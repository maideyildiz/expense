...
namespace ExpenseTracker.Tests.Infrastructure.Test
{
    public class GetAllTest
    {
        ...
        public async Task GetAllAsync_ReturnsAllItems()
        {
            ...
            mockDocumentSnapshot.Setup(d => d.ConvertTo<ExpenseTracker.Core.Models.Base>()).Returns(new ExpenseTracker.Core.Models.Base());
            ...
            Assert.IsType<List<ExpenseTracker.Core.Models.Base>>(result);
